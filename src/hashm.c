...
/*!
  \def DEFAULT_LDFACT
  \brief Default load factor, used in hash_map_create fucntion if invalid load factor is given.
*/

/*!
  \def DEFAULT_CAPACY
  \brief Default capacity, used in hash_map_create fucntion if invalid capacity is given.
*/

/*!
  \var typedef struct hash_bucket bucket
  \brief Typedef of struct hash_bucket to 'bucket'.
*/

/*!
  \struct hash_bucket
  \brief Fundamental hash bucket structure.
  \var hash_bucket::key
